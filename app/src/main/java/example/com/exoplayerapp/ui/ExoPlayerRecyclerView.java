package example.com.exoplayerapp.ui;
...
import example.com.exoplayerapp.utils.VideoPlayerConfig;
...
//                    .createMediaSource(Uri.parse(uriString));
            MediaSource  videoSource = new HlsMediaSource.Factory(dataSourceFactory).createMediaSource(Uri.parse(uriString));
